...
module.exports = async (req, res) => {
    ...
    if (req.body.email == null || req.body.fname == null || req.body.fname == null || req.body.password == null || req.body.phoneNumber == null) {
    ...
    try {
        ...
        // let encrypted = CryptoJS.AES.encrypt(pass, "Secret Passphrase");
            ...
            function (err, result) {
                ...
                if (result[0].emails === 0) {
                    ...
                    pool.query(insertQuery,
                        [req.body.fname, req.body.lname, req.body.email, hash, '0', req.body.phoneNumber],
                        function (err, result) {
                            if (err) {
                                console.log(err);
                                throw err;
